...
class CVAnalysis(Base):
    ...
    cover_letter = Column(JSON, nullable=True)  # Phase 7
    learning_recommendations = Column(JSON, nullable=True)  # Phase 8
    interview_prep = Column(JSON, nullable=True)  # Phase 9
